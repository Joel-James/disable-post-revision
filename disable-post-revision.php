 ...
 * Plugin URI:      https://thefoxe.com/products/disable-post-revision/
 ...
 * Text Domain:     disable-post-revisions
...
if ( ! class_exists( 'Disable_Post_Revision' ) ) {
    ...
    class Disable_Post_Revision {
        ...
        public function options_page() {
            ...
            add_settings_field(
                'dpr_label',
                '<label for="dpr">' . __( 'Disable Post Revisions' , 'disable-post-revisions' ) . '</label>',
                array( &$this, 'fields' ),
                'writing'
            );
	}
        ...
        public function fields() {
            ...
            echo '</select>';
            echo '<p class="description">' . __('To select multiple post types, hold ctrl key while selecting', 'disable-post-revisions') . '</p>';
            echo '<p class="description"><strong>' . __('Note', '') . ':</strong> ' . __('Do not select a post type if you are not sure about it', 'disable-post-revisions') . '</p>';
	}
    }
